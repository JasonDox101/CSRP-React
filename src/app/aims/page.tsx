  ...
  return (
    <main className="mx-auto max-w-[1200px] px-6 py-16 md:px-10">
      ...
      <ul className="space-y-8">
        {aims.map((aim) => (
          <li key={aim.number} className="flex items-start gap-5">
            ...
            <div className="flex-1 space-y-2">
              ...
              {aim.bullets ? (
                <ol className="mt-3 list-decimal space-y-2 pl-5 text-[15px] leading-relaxed text-[var(--harvard-dark)] md:text-base">
